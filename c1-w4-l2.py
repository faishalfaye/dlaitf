...
print('total training horse: ', len(train_human_names))
print('total training human: ', len(train_human_names))
...
history = model.fit_generator(
    train_generator,
    steps_per_epoch=8, #I write 8 because the training images consists of 1024 images, and I got batch_size = 128
    epochs=15,
    verbose=1)
